...
import {black, darkBlue, darkCyan} from "./colors";
...
export const MAIN_GRADIENT = `linear-gradient(to bottom, ${darkBlue}, ${darkCyan})`

export const APPNAV_HEIGHT = '80px'
export const APPNAV_BACKGROUND = darkCyan
